       ...
       <div className='container p-3'>
        <div className='row p-5'>
            <div className='col-6 p-5'>
               ...
               <p className='text-muted'> That's why 1.5+ crore customers trust Zerodha with ₹4.5+ lakh crores of equity investments and contribute to
               ...
               <p className='text-muted'>With initiatives like Nudge and Kill Switch, 
